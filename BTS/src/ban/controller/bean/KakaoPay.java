...
import bts.model.vo.KakaoPayReadyVO;
...
public class KakaoPay {
	 ...
	 * "57db4de065a116961a65a942b594e3ad"); headers.add("Accept",
	 ...
	 * params.add("partner_order_id", "1001"); params.add("partner_user_id",
	 * "gorany"); params.add("item_name", "갤럭시S9"); params.add("quantity", "1");
	 * params.add("total_amount", "2100"); params.add("tax_free_amount", "100");

...
//	 
	 ...
	 public String naverToken (String authorize_code) {
		 String access_Token = "";
		 String refresh_Token = "";
		 ...
		 try {
			 ...
			 StringBuilder sb = new StringBuilder();
			 sb.append("grant_type=authorization_code");
			 sb.append("&client_id=0KysF2IHcVjPstU2EXpu");
			 sb.append("&redirect_uri=http://localhost:8080/BTS/banThing/naverlogin");
			 sb.append("&code=" + authorize_code);
			 sb.append("&client_secret=OPJ8lGRgac");
			 bw.write(sb.toString());
			 bw.flush();
	 ...
	 public Map naverInfo (String access_Token) {
